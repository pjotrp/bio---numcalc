...
ParameterException::ParameterException(const char *   text, const Parameter * param) :
	Exception("ParameterException: " + string(text) + (param != NULL ? "(" + param -> getName() + ")" : "")),
	parameter(param) {};
		
ParameterException::ParameterException(const string & text, const Parameter * param) :
	Exception("ParameterException: " + text + (param != NULL ? "(" + param -> getName() + ")" : "")),
	parameter(param) {};
...
ParameterNotFoundException::ParameterNotFoundException(const char *   text, const string & param) :
	Exception("ParameterNotFoundException: " + string(text) + (!TextTools::isEmpty(param) ? "(" + param + ")" : "")),
	parameter(param) {};
		
ParameterNotFoundException::ParameterNotFoundException(const string & text, const string & param) :
	Exception("ParameternotFoundException: " + text + (!TextTools::isEmpty(param) ? "(" + param + ")" : "")),
	parameter(param) {};
