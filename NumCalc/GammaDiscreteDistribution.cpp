...
double GammaDiscreteDistribution::LnGamma (double alpha)
{
...
double GammaDiscreteDistribution::PointChi2 (double prob, double v)
{
...
vector<double> GammaDiscreteDistribution::computeBounds(unsigned int nbClasses, double alfa, double beta)
{
	...
	bounds[0] = 0;
	for(unsigned int i = 1; i < nbClasses; i++) bounds[i] = PointGamma((double)i/(double)nbClasses, alfa, beta);
